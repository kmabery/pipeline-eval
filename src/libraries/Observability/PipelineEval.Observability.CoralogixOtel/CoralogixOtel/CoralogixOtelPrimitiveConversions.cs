...
/// <summary>
/// Vendored from serilog/serilog-sinks-opentelemetry v4.2.0 (Apache-2.0); see CoralogixOtlpEventBuilder for rationale.
/// </summary>
static class CoralogixOtelPrimitiveConversions
{
